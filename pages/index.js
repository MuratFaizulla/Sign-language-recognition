...
import { gestureDescriptions } from "../utils/const.js"
        ...
        <Container centerContent maxW="xl" height="100vh" pt="0" pb="0">
          ...
          <Box id="webcam-container">
            ...
            {sign ? (
              ...
              >
                {/* Отображаем текстовое описание, если оно есть */}
                {Signimage[sign]?.text ? (
                  <p>{Signimage[sign].text}</p>
                ) : (
                  <p>{sign}</p> // Если текста нет, показываем сам символ жеста
                )}
                ...
                {Signimage[sign]?.src ? (
                  ...
                  <img
                    alt="default emoji"
                    src="/loveyou_emoji.svg" // Изображение по умолчанию
                    style={{
                      height: 30,
                    }}
                  />
